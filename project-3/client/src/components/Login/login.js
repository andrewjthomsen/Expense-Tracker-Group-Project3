    ...
    <div className="main-w3layouts wrapper" id="Login">
      ...
      <div className="main-agileinfo">
        ...
        <form onSubmit={this.handleSubmit}>
            ...
            <input className="text email" type="email" name="email" placeholder="Email" required value={this.state.email} onChange={this.handleChange}  />
            
            <input className="text" type="password" name="password" placeholder="Password" required />
            
            <input className="text w3lpass" type="password" name="password" placeholder="Confirm Password" value={this.state.password} />
