...
import "../../assets/socicon/css/style.css"
...
<section className="menu cid-roBIQr2OFc" once="menu" id="menu1-0">
    ...
    <nav className="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
                        <a className="nav-link link text-success display-4" href="/profile"><span class="mbri-cash mbr-iconfont mbr-iconfont-btn"></span>
                ...
                <div className="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-success-outline display-4" href="/signup">
